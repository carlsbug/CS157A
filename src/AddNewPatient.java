					 ...
					 
				  {
				    		   ...
				    		   && !city.equals("") && !zipCode.equals("") && !country.equals("") && !SSN.equals(""))
				       {
							...
							String[] InsertRows = {"INSERT INTO Patient(THC, CurrentDate, First_name, Middle_name, Last_name, Date_of_Birth,\n" + 
									...
									"				VALUES("+THC+",'"+CDate+"','"+fName+"','"+mName+"','"+lName+"','"+dOB+"','"+gender+"',"+Integer.parseInt(phone)+",'"+email+"','"+street+"','"+city+"','"+state+"',"+Integer.parseInt(zipCode)+",'"+country+"','"+photo+"',"+SSN+",'"+insurance+"',(SELECT STATE_ID FROM REF_State WHERE Name = 'CALIFORNIA'), \n" + 
